#!/usr/bin/env python3
"""Image MCP server for caw-agent (Content-Length stdio JSON-RPC)."""
...
from process import ImageError  # noqa: E402
from tools import call_tool, list_tool_specs  # noqa: E402

SERVER_NAME = "image-mcp"
SERVER_VERSION = "1.0.0"
PROTOCOL_VERSION = "2024-11-05"


def log(msg: str) -> None:
    path = os.environ.get("IMAGE_MCP_LOG")

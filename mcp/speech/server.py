#!/usr/bin/env python3
"""Speech MCP server for caw-agent (Content-Length stdio JSON-RPC)."""
...
from transcribe import SpeechError  # noqa: E402

SERVER_NAME = "speech-mcp"
SERVER_VERSION = "1.0.0"
PROTOCOL_VERSION = "2024-11-05"


def log(msg: str) -> None:
    path = os.environ.get("SPEECH_MCP_LOG")
    line = f"[speech-mcp] {msg}\n"
    if path:
        try:
